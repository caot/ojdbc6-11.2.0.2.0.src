...
class T4CVarnumAccessor extends VarnumAccessor
{
    ...
    throws SQLException, IOException
  {
    ...
    this.mare.unmarshalCLR(this.rowSpaceByte, k + 1, this.meta, this.byteLength - 1);

    this.rowSpaceByte[k] = ((byte)this.meta[0]);
    ...
    throws SQLException, IOException
  {
    ...
    if (!this.isNullByDescribe)
    {
      System.arraycopy(this.rowSpaceByte, k, this.rowSpaceByte, j, i3 + 1);
    }
    ...
    throws SQLException
  {
    ...
    if (i2 != 0)
    {
      System.arraycopy(paramArrayOfByte, j, this.rowSpaceByte, i, i2 + 1);
    }
  }
